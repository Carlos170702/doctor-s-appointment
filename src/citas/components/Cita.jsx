        ...
        <div className="cita">
            ...
            <div className="cita__content">
                <div className="cita__data">
                    <p className='cita__tittle'>Nombre:</p>
                    <span className='cita__info'>Carlos daniel cruz peréz</span>
                </div>
                <div className="cita__data">
                    <p className='cita__tittle'>Concepto:</p>
                    <p className='cita__info'>Dolor de cabeza</p>
                </div>
                ...
                <div className="cita__data">
                    <h4 className='cita__tittle'>Descripción:</h4>
